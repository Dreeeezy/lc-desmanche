...
lcARC = {}
Tunnel.bindInterface("lc_desmanche",lcARC)

function lcARC.ChecarCartaoAcesso() 
	local user_id = vRP.getUserId(source)
	if vRP.tryGetInventoryItem(user_id, "lockpick") then		
		return true
	else
		return false
	end
