...
lcARC = Tunnel.getInterface("desmanche")
...
local FrenteDoPC = {1208.74,-3115.01,5.55}
local TextosInvasao = {
...
-- ETAPA 4
local Desmanche = {1204.59,-3116.23,5.55}
local SpawnDesmanchador = {1209.28,-3119.59,5.55}
    ...
    while true do
            ...
            if DistPc <= 10 then
                ...
                if DistPc <= 1.5 then
                    ...
                    if IsControlJustPressed(0, 38) then
                        if lcARC.ChecarCartaoAcesso() then
                            ...
                            TriggerEvent('Notify', 'vermelho', 'Você não possui um cartão de acesso.',5000)
                        end
                    end
                end
            end
        ...
        if etapa == 5 then
            if CarroNoLugar then
                ...
                if IsControlJustPressed(0,38) then
                    if lcARC.checkVehicle() then
                        TriggerServerEvent("desmancheVehicles")
                        lcARC.setSearchTimer()                                                
